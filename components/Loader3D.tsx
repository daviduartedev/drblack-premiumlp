 ...
 *  - Slide-up no fim (yPercent: -100) revelando a hero por baixo.
 */
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        delay: 0.35,
        onComplete: () => {
          // Slide-up estilo KPR: loader sobe revelando a hero.
          // onRequestFlip dispara no onStart pra hero comecar junto.
