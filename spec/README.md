...
- `spec/features/painel-admin-ruby-safira/` - feature criada no ciclo `cycles/Q12026/0006-painel-admin-ruby-safira/`. Define novas secoes/efeitos Ruby/Safira, dashboard cliente, painel admin, ficha tecnica, calculadora de lucro, loja `/loja`, Supabase Auth, Vercel Blob e RLS (ciclos `cycles/Q22026/0524-platform-skins-store-backend/`, `cycles/Q22026/0526-fix-admin-publish-calculator/` — calculadoras duplas skin/rifa, publicacao `/loja` e `/rifas`, persistencia de rifa).
